...
export const CartelleControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        provaReactEndpoint: async (body: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('provaReactEndpoint', 'body', body)
            const localVarPath = `/cartelle/prova`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const CartelleControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async aggiungiCartella(cartellaParams: CartellaParams, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GenericResponseDtoString>> {
         ...
         * @throws {RequiredError}
         */
        async provaReactEndpoint(body: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GenericResponseDtoString>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.provaReactEndpoint(body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CartelleControllerApi.provaReactEndpoint']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Rinominare una cartella cartella e aggiornare i path dei file contenuti in essa
         ...
         * @throws {RequiredError}
         */
        async rinominaCartella(modificaCartellaParams: ModificaCartellaParams, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GenericResponseDtoString>> {
...
export const CartelleControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Creazione della cartella dove storicizzare i file e aggiornamento db
         * @summary Creazione della cartella
         * @param {CartelleControllerApiProvaReactEndpointRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        provaReactEndpoint(requestParameters: CartelleControllerApiProvaReactEndpointRequest, options?: RawAxiosRequestConfig): AxiosPromise<GenericResponseDtoString> {
            return localVarFp.provaReactEndpoint(requestParameters.body, options).then((request) => request(axios, basePath));
        },
        /**
         * Rinominare una cartella cartella e aggiornare i path dei file contenuti in essa
         * @summary Rinominare una cartella cartella
...
/**
 * Request parameters for provaReactEndpoint operation in CartelleControllerApi.
 * @export
 * @interface CartelleControllerApiProvaReactEndpointRequest
 */
export interface CartelleControllerApiProvaReactEndpointRequest {
    /**
     * 
     * @type {string}
     * @memberof CartelleControllerApiProvaReactEndpoint
     */
...
export class CartelleControllerApi extends BaseAPI {
     ...
     * @memberof CartelleControllerApi
     */
    public provaReactEndpoint(requestParameters: CartelleControllerApiProvaReactEndpointRequest, options?: RawAxiosRequestConfig) {
        return CartelleControllerApiFp(this.configuration).provaReactEndpoint(requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
